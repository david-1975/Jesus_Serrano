...
x.innerHTML = "El ancho de la ventana del navegador es : " + w + "px, Alto: " + h + "px.";
}
...
"La localización de la página es: " + window.location.pathname;
}
function dominioPagina() { 
document.getElementById("infoPantalla").innerHTML =
"El hostname de la página es: " + window.location.hostname; 
}
function urlPagina() { 
document.getElementById("infoPantalla").innerHTML =
"La ruta de página es: " + window.location.href;}
function rutaPagina() { 
document.getElementById("infoPantalla").innerHTML =
"La ruta de página es: " + window.location.pathname;
}
