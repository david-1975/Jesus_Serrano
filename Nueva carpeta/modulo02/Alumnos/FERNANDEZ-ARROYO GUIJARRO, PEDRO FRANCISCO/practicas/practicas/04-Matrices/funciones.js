...
function fun2() {
    ...
    //        dato.split(".") ||
    //        dato.split("-"); //posicion del caracter @ o -1
    //  var array2 = array1.push(matriz);

    array1.push("Volkswagen");
    array1.push("Bentley");
    array1.push("Bugatti");
    ...
    document.getElementById("idres2").innerHTML = matriztabla;
...
function fun3() {
    ...
    for (i = 0; i >= matriz.length(); i++) {
        if (i === 0) { matriztabla = "<li>" + matriz[i] + "</li>" + "<br>"; } else { matriztabla = matriztabla + "<li>" + matriz[i] + "</li>" + "<br>"; }
    }

    document.getElementById("idres3").innerHTML = matriztabla;
