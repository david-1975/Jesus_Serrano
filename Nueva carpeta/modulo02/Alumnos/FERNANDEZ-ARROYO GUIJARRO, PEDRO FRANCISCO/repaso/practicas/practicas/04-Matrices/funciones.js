...
//Crea una función que, introduciendo 3 valores en un campo de formulario, cree  una matríz que almacene estos 
//valores &quot;Seat&quot;, &quot;Audi&quot;, &quot;Skoda&quot; sin espacios en blanco. Mostrar la matriz en 
//foma de linea horizontal.
// Seat Audi Skoda
function  fun1() {
	var dato = document.getElementById("campo1").value;//string
//	var matriz = new Array();//Object
	var matriz = dato.split(" ") || 
				 dato.split(",") || 
				 dato.split(".") || 
				 dato.split("-");//posicion del caracter @ o -1
	   
	
	document.getElementById("idres1").innerHTML = "Grupo Volkswagen: " + matriz;
	document.getElementById("campo2").value = matriz;

}
//A partir de la matríz anterior, crear una función que permita introducir<em> &quot;Volkswagen&quot;, 
//&quot;Bentley&quot;, &quot;Bugatti&quot;</em>  al conjunto, y los situe detrás de los valores existentes 
//sin espacios en blanco. Mostrar la matriz como una lista ordenada <ol> <li></li> </ol>
function  fun2() {
	var array1 = ["Seat", "Audi", "Skoda"];
	var dato = document.getElementById("campo2").value;
// 	var matriz = dato.split(" ") || 
//				 dato.split(",") || 
//				 dato.split(".") || 
//				 dato.split("-");//posicion del caracter @ o -1
	var array2 = array1.push(dato);
	var array3 = array1.sort();
	
/*   matriz.push("Volkswagen");
   matriz.push("Bentley");
   matriz.push("Bugatti");*/
//   var array2 = new Array(matriz);

   

 	document.getElementById("idres2").innerHTML = "Grupo Volkswagen: " + array3; 
 	document.getElementById("campo3").value = array1.sort();
}
//Array)
//A partir de la matríz anterior, crear una función que permita introducir al comienzo de la matríz 
//los valores "Ducati", "Lamborghini", "Porsche" sin espacios en blanco. Mostrar la matriz como una 
//tabla.
function  fun3() {
	var dato = document.getElementById("campo3").value;
 	var matriz = dato.split(" ") || 
				 dato.split(",") || 
				 dato.split(".") || 
				 dato.split("-");//posicion del caracter @ o -1
   matriz.unshift("Porsche");
   matriz.unshift("Lamborghini");
   matriz.unshift("Ducati");
 //  var array1 = new Array(matriz);
   
   var matriztabla;
   var i;
   for (i === 0; i >= matriz.length(); i++ ){
	   if (i === 0){matriztabla = "\"" + matriz[i] + "\"" + "<br> +";}
		else {matriztabla = matriztabla + "\"" + matriz[i] + "\"" + "<br>+";}
   }
alert(matriztabla);
 	document.getElementById("idres3").innerHTML = "Grupo Volkswagen: " + matriztabla; 
 	document.getElementById("campo3").value = matriz;
	}
...
// validarHora()
	...
	document.getElementById("idres4").innerHTML = dato ;
}
