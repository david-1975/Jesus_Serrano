...
txt += "<p><b>Usuario-Agente header: </b>" + window.navigator.userAgent + "</p>";// UserAgent
...
function tamanoVentana() {
	...
	var x = document.getElementById("infVentana");
	x.innerHTML = "El ancho actual de la ventana en este navegador: " + "<b>" + w + "px, y el alto es : " + h + "px."+ "<b>";
}

//PANTALLA   // Ancho y alto de Pantalla total
function pantalla() { 
...
//PANTALLA window....
function urlPantalla() {
	document.getElementById("infPantalla").innerHTML =	"La página se localiza en: " + window.location.href;
}

function hostnamePantalla() {
	document.getElementById("infPantalla").innerHTML =	"La página se localiza en: " + window.location.hostname;
}

function pathnamePantalla() {
	document.getElementById("infPantalla").innerHTML =	"La página se localiza en: " + window.location.pathname;
}

function protocolPantalla() {
	document.getElementById("infPantalla").innerHTML =	"La página se localiza en: " + window.location.protocol;
}

function assignPantalla() {
	document.getElementById("infPantalla").innerHTML =	"La página se localiza en: " + window.location.assign;
}
...
function confirmar() {
	window.confirm("Este es un mensaje de confirmación");
}

function promp() {
	window.prompt("En este mensaje tu me contestas");
}
...
function intervalo() {
	window.setInterval();
	alert("Hola, ya pasaron 3000 milisegundos");
}
