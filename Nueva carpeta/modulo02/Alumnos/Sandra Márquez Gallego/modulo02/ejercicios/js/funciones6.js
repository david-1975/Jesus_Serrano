...
document.getElementById("infoVentana").innerHTML = "La ventana del navegador tiene un ancho de: " + w + " px, y un de alto de: " + h + " px.";
}
...
/*function urlPagina(){
	var url="https://www.w3schools.com/js/js_window_location.asp";
	document.getElementById("infoPantalla").innerHTML = "la localización de la página es:<br>" + window.location.href;
}
...
function puertoPagina(){
	document.getElementById("demo").innerHTML = "El número de puerto actual es: " + window.location.port;
