...
function aExponencial() {
	 var res = "";
	 var num1= 5.56789; var num2= 4.56789;  var num3= 3.56789;  var num4= 45.6789;  var num5= 2.5679;  var num6= 0.56889;
...
function aCadena() {
	...
	document.getElementById("demo2").innerHTML = "<h3>Resultado del uso </h3>" + "\n" +
	"El número 15 su valor en decimal es : "+ "\"" + decimal+ "\""  + "<br>" + 
...
function valorDe() {
	...
	document.getElementById("demo2").innerHTML = "<h3>Resultado del uso </h3>" + "\n" +
	"El valor de la variable array  es : " + a + " y es de tipo: " + typeof(ar) + "<br>" + 
	"El valor de la variable objeto es : " + b +  " y es de tipo: " + typeof(obj) + "<br>" +
	"El valor de la variable cadena es : " + c + " y es de tipo: " + typeof(cad) + "<br>" + 
	"El valor de la variable número es : " + d + " y es de tipo: " + typeof(num) + "<br>" + 
	"El valor de la variable booleans es : " + e + " y es de tipo: " + typeof(bol);
