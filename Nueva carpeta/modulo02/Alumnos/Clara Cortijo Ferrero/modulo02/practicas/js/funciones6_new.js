...
document.getElementById("infoVentana").innerHTML = "Ancho de la ventana del navegador: " + w + "px, alto: " + h + "px.";
}
...
function urlPath() {
document.getElementById("infoPantalla").innerHTML =
"El path de la página es: " + window.location.pathname;

}

function urlProtocolo() {
document.getElementById("infoPantalla").innerHTML =
...
function urlPuerto(){
document.getElementById("infoPantalla").innerHTML = 
"El número de puerto de la URL de esta página es: " + window.location.port;
}

function cargarNueva() {
...
function historialDelante() {
	
	window.history.forward();
	
	}
	
function historialDetras() {
...
// CAJAS DE ALERTA POPUPS


function alerta() {
	window.alert("Sólo sirve para dar un mensaje o informar al usuario.")
	}
	
	
function confirmar() {
	window.confirm("Sirve para que el usuario acepte o rechace algo. Ej: ¿Quiere enviar el formulario?")
	}

function meteDato() {
	window.prompt("Se usa para que el usuario introduzca un input, necesario para ejecutar la función. Ej: Introduce tu nombre:")
	}
...
function alertarhola() {
    alert('Hello');
}

function myTimer() {
    var d = new Date();
    document.getElementById("divTiempo").innerHTML = d.toLocaleTimeString();
}
