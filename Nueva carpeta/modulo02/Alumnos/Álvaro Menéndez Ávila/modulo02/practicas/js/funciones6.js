...
document.getElementById("ventana").innerHTML = "Browser inner window width: " + w + ", height: " + h + ".";
}
...
// v
function urlPagina() {
document.getElementById("infoDOM").innerHTML = 
"La localización de la página es: " + window.location.href;
}

function locationPagina() {
document.getElementById("infoDOM").innerHTML = 
...
document.getElementById("infoDOM").innerHTML = 
"El puerto de la URL contenida en la página actual es: " + window.location.port;
}
...
function pronto() {
	window.prompt("A la espera de una órden", "orden por defecto");
}
