...
document.getElementById("demo2").innerHTML = "<h3>Resultado del uso </h3>" + "\n" +
"El valor de la variable a es : " + a + " y es de tipo: " + typeof(arr) + "<br>" +
"El valor de la variable b es : " + b + " y es de tipo: " + typeof(obj) + "<br>" + 
"El valor de la variable c es: " + c + " y es de tipo: " + typeof(cad) + "<br>" + 
"El valor de la variable d es: " + d + " y es de tipo: " + typeof(num) + "<br>" + 
"El valor de la variable e es : " + e + " y es de tipo: " + typeof(bol) + "<br>";
