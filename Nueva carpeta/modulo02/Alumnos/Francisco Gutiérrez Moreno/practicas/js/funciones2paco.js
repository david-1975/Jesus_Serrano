...
function valorDe() {
	...
	"El valor de la variable arr es: " + b + "y es de tipo " + typeof(obj) + "<br>" +
	"El valor de la variable obj es: " + c + "y es de tipo " + typeof(num) + "<br>" +
	"El valor de la variable arr es: " + d + "y es de tipo " + typeof(cad) + "<br>" +
	"El valor de la variable arr es: " + e + "y es de tipo " + typeof(bol) + "<br>" +
	}