...
document.getElementById("infoVentana").innerHTML = " El ancho de la  ventana del navegador(Browser) es  : " + w + "px"+ ", y de alto es : " + h + "px" + ".";
}
...
" La localización de la pagina es : " + window.location.href;
	}

function dominioPagina(){
	document.getElementById("infoPantalla").innerHTML =
" El host de la pagina es " + window.location.hostname;
	
	}
function rutaPagina(){
	document.getElementById("infoPantalla").innerHTML =
" La info de la url de la pagina es : " + window.location.pathname;
...
function puertoPagina(){
	document.getElementById("infoPantalla").innerHTML =
" El numero del puerto es : " + window.location.port;
...
function confirmar(){
	window.confirm("presiona para confirmar");
	}
function promp(){	
window.prompt("Please enter your name", "Rebeca Leon");
}
