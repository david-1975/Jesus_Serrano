...
document.getElementById("demo2").innerHTML = "<h3>Resultado del uso </h3>" + "<br>" +
"El valor de la variable a es : " + a + " y es de tipo: " + typeof(arr) +
"<br>" +
...
document.getElementById("demo1").innerHTML = 
"<h3>El método valueOfl</h3> ()<p> convierte un número en una notación exponencial.</p>";
