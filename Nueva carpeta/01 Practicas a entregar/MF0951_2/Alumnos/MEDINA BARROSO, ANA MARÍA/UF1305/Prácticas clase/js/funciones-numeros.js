...
function esEntero() {
	...
	document.getElementById("demo2").innerHTML = res;
	document.getElementById("demo1").innerHTML = "<p>El método Number.isInteger() determina si un valor es un número entero. Este método devuelve verdadero si el valor del número es equivale a un número entero, de lo contrario, devuelve falso.</p>" + "<p>El método Number.isInteger() es diferente a la función global Number(). La función global Number() convierte el argumento objeto a un número que representa el valor del objeto. El método Number.isInteger() no convierte los valores a un número, y no devolverá verdadero si el valor no es de tipo Number. El método Number.isInteger() devuelve un valor booleano, true o false. Si el valor es NaN o infinito, devuelve false.</p>";
	document.getElementById("contenedor").style.display = "block";
}
...
function noEsNumero() {
	...
	document.getElementById("demo2").innerHTML = res;
	document.getElementById("demo1").innerHTML = "<p>El método Number.isNaN() determina si un valor es NaN (No-A-Number). Este método devuelve verdadero si el valor no es equivale a un número, de lo contrario, devuelve falso.</p>" +
...
function aExponencial() {
	...
	document.getElementById("demo2").innerHTML = res;
	document.getElementById("demo1").innerHTML = "<p>El método number.toExponential(x) convierte un número en exponencial. Este método devuelve una cadena (string) que representa el objeto de tipo Number en notación exponencial.</p>" + "<p>Como opcional, se puede indicar dentro del paréntesis de la función toExponential() el número de dígitos que se utilizarán para representar el número en exponencial, los número van del 0 al 20." + "Si no se especifica nungún valor dentro del paréntesis se utilizaran por defecto tantos dígitos decimales como hagan falta para acomodar el número.</p>";
	document.getElementById("contenedor").style.display = "block";
}
...
function aFijar() {
	...
	document.getElementById("demo2").innerHTML = res;
	document.getElementById("demo1").innerHTML = "<p>El método number.toFixed () devuelve una cadena, que representa un número, con el número exacto de decimales. Dentro del paréntesis se indica el número de dígitos que se utilizarán para representar los decimales.</p>" + "Si el número deseado de decimales es más alto que el número real, la función toFixed(), añadirá ceros para crear la longitud deseada decimal. Si el valor de los decimales es 0 o se deja en blanco, se mostrará sólo la parte entera del número. Si el número de decimales es mayor que 1e+21, este método, simplemente, llama a la función Number.prototype.toString() y devuelve una cadena en notación exponencial.</p>";
	document.getElementById("contenedor").style.display = "block";
}
...
function aPrecision() {
	...
	document.getElementById("demo2").innerHTML = res;
	document.getElementById("demo1").innerHTML = "<p>El método number.toPrecision(precision) devuelve una cadena que representa un objeto Number según la precisión especificada. Dentro del paréntesis se indica el parámetro precisión, que es el número de dígitos que se utilizarán para representar el número.</p>" + "<p>Si el número de la precisión, es más alto que el número real, la función toPrecision(), añadirá ceros para crear la longitud deseada. Si el parámetro precision es omitido se mostrará el número tal cual. Si el parámetro precision es un valor no entero, el valor es redondeado al entero más cercano.</p>";
	document.getElementById("contenedor").style.display = "block";
}
...
function aCadena() {
	...
	document.getElementById("demo2").innerHTML = res; 
	document.getElementById("demo1").innerHTML = "<p>El método number.toString(base) convierte un número en una cadena, usando diferentes bases. Dentro del paréntesis se indica el parámetro base, que es la base de representación numérica de dígitos que se utilizará para representar el número.</p>" + "<p>Como opcional, se puede indicar qué base utilizar para representar un valor numérico. Debe ser un número entero entre 2 y 36. Si no se especifica la base, JavaScript asume la base predefinida, que es 10, formato decimal. </p>" + "<p>Por ejemplo, el método number.toString() representa un número en base 2 como binario, en base 8 como Octal y en base 16 como hexadecimal.</p>";
	document.getElementById("contenedor").style.display = "block";
}
//
////Método valueOf()
function valorDe() {
	...
	document.getElementById("demo2").innerHTML = res; 
	document.getElementById("demo1").innerHTML = "<p>El método number.valueOf() devuelve el valor primitivo de una variable. Dentro del paréntesis no se indica parámetro alguno, Por delante del método se escribe el nombre del dato a evaluar. Puede ser, variable, objeto, array, string, number o función.</p>" + "<p>Este método no cambia el valor original, sólo devuelve el valor simple de un número. Si un objeto no tiene un valor, valueOf devuelve el objeto en sí.</p>";
	document.getElementById("contenedor").style.display = "block";
}
//
////Método Number//
function convertirNumero(){
	...
	document.getElementById("demo3").innerHTML = "<p>La función Number() convierte el argumento del objeto en un número que representa el valor del objeto.</p>"+ "<p>  Si el valor no se puede convertir a un número legal, se devuelve NaN. </p>"+ "<p> <strong>Nota</strong>: Si el parámetro es un objeto Fecha, la función Número () devuelve el número de milisegundos desde la medianoche del 1 de enero de 1970 UTC.</p>";
...
function puntoflotante(){
	...
	document.getElementById("demo3").innerHTML = "<p>La función parseFloat () analiza una cadena y devuelve un número de punto flotante.</p>"+"<p> Esta función determina si el primer carácter en la cadena especificada es un número. Si es así, analiza la cadena hasta que llega al final del número y devuelve el número como un número, no como una cadena.</p>"+ "<p> <strong>Nota</strong>: ¡ Solo se devuelve el primer número en la cadena! </p>"+"<p> <strong>Nota</strong>: Se permiten espacios iniciales y finales.</p>" +"<p><strong>Nota</strong>: Si el primer carácter no se puede convertir en un número, parseFloat () devuelve NaN.</p>";
...
function entero(){
	...
	document.getElementById("demo3").innerHTML = "<p> La función parseInt () analiza una cadena y devuelve un entero. El parámetro radix se usa para especificar qué sistema numérico se usará, por ejemplo, un radix de 16 (hexadecimal) indica que el número en la cadena se debe analizar desde un número hexadecimal a un número decimal.</p>"+"<p> Si se omite el parámetro radix, JavaScript asume lo siguiente: </p>" + "<p> * Si la cadena comienza con "+"0x"+ ", la raíz es 16(hexadecimal)</p>" + "<p> * Si la cadena comienza con "+"0"+", la raíz es 8 (octal). Esta característica está en desuso </p>"+"<p> * Si la cadena comienza con cualquier otro valor, la raíz es 10 (decimal)</p>"+ "<p> <strong>Nota</strong>: ¡ Solo se devuelve el primer número en la cadena!</p>"+"<p> Nota: Se permiten espacios iniciales y finales.</p>" +"<p> <strong>Nota</strong>: Si el primer carácter no se puede convertir en un número, parseInt () devuelve NaN.</p>"; 
	document.getElementById("demo4").innerHTML = n;
...
function cerrar2(){
  ...
  var btnText = document.getElementById("boton2");
