...
//	res=res + "¿El número 1,23 es finito? " + "<strong>" + Number.isfinite(1.23) +"</strong><br>";
//	res=res + "¿El número \"123\" es finito? " + "<strong>" + Number.isfinite('123') +"</strong><br>";
//	res=res + "¿El número \"Hola\" es finito? " + "<strong>" + Number.isfinite('Hola') +"</strong><br>";
//	res=res + "¿El número \"2000/12/20\" es finito? " + "<strong>" + Number.isfinite('2000/12/20') +"</strong><br>";
