...
function esEntero() {
		var res="";
		res = res + "¿Es entero 123? " + "<strong>" +
		Number.isInteger(123) + "</strong><br>";
		res = res + "¿Es entero -1.23? " + "<strong>" +
		Number.isInteger(-1.23) + "</strong><br>";
		res = res + "¿Es entero 5-2? " + "<strong>" +
		Number.isInteger(5-2) + "</strong><br>";
...
function noEsNumero() {
		var res="";
		res = res + "¿Es un NO número 123? " + "<strong>" +
		isNaN(123) + "</strong><br>";
		res = res + "¿Es un NO número madrid? " + "<strong>" +
		isNaN("madrid") + "</strong><br>";
