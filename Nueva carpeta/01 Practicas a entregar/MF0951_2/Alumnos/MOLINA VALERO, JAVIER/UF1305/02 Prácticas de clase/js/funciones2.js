...
var res="";
	...
	res=res+"¿El número es 0/0 finito?" +"<strong> "+Number.isFinite(0/0)+"</strong><br>";
...
function esEntero() {
	...
	res=res+"¿El número es 0/0 entero?" +"<strong> "+Number.isInteger(0/0)+"</strong><br>";
	res=res+"¿El número \"100\"-10 es entero? " +"<strong>"+Number.isInteger('100'-10)+"</strong><br>";
...
function noEsNumero() {
	...
	var res="";
	res=res+"¿123 no es un número? " +"<strong>"+isNaN(123)+"</strong><br>";
	res=res+"¿-1.23 no es un número? " +"<strong>"+isNaN(-1.23)+"</strong><br>";
	res=res+"¿5-2 no es un número? " +"<strong>"+isNaN(5-2)+"</strong><br>";
	res=res+"¿0 no es un número? " +"<strong>"+isNaN(0)+"</strong><br>";
	res=res+"¿1.23 no es un número? " +"<strong>"+isNaN(1.23)+"</strong><br>";
	res=res+"¿'123' no es un número? " +"<strong>"+isNaN('123')+"</strong><br>";
	res=res+"¿\"Hello\" no es un número? " +"<strong>"+isNaN('Hello')+"</strong><br>";
	res=res+"¿\"2005/12/12\" no es un número? " +"<strong>"+isNaN('2005/12/12')+"</strong><br>";
	res=res+"¿5*2 no es un número?" +"<strong> "+isNaN(5*2)+"</strong><br>";
	res=res+"¿5/2 no es un número?" +"<strong> "+isNaN(5/2)+"</strong><br>";
	res=res+"¿0/0 no es un número?" +"<strong> "+isNaN(0/0)+"</strong><br>";
	res=res+"¿\"100\"-10 no es un número? " +"<strong>"+isNaN('100'-10)+"</strong><br>";
...
function aExponencial() {
	...
	res=res+"El número " +num+ "exponencial con 1 dígito es" +"<strong>"+num.toExponential(1)+"</strong><br>";
