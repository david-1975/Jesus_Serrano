...
function esFinito() {
   var res= "";
	...
	res = res +"¿El número \"0 / /\" es finito? "+ "<strong>" + Number.isFinite('0/0') + "</strong>>br>";
	res = res +"¿El número \"100\" - 10\"123 es finito? "+ "<strong>" + Number.isFinite("100"-10) + "</strong>>br>";
...
function esEntero() {
	...
	res = res +"Es entero  \"0 / /\": "+ "<strong>" + Number.isInteger('0/0') + "</strong>>br>";
...
function noEsNumero() {
	...
	res = res +"¿Es un número 0:"+ "<strong>" + Number.isNaN(0) + "</strong>>br>";
	res = res +"¿Es un número 1.23: "+ "<strong>" + Number.isNaN(1.23) + "</strong>>br>";
	res = res +"¿Es un número \"123\": "+ "<strong>" + Number.isNaN('123') + "</strong>>br>";
	...
	res = res +"¿Es un número \"0 / /\": "+ "<strong>" + Number.isNaN('0/0') + "</strong>>br>";
	res = res +"¿Es un número \"10\" + 20: "+ "<strong>" + Number.isNaN("10"+20) + "</strong>>br>";
