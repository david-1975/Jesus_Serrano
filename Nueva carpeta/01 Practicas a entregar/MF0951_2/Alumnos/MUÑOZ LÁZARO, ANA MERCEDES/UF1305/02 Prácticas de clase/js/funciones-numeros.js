...
document.getElementById("demo4").innerHTML = 
	"<p>La función de Número () convierte el argumento objeto a un número que representa el valor del objeto.Si el valor no se puede convertir en un número legal, se devuelve NaN. <br> Nota: Si el parámetro es un objeto Date, la función Number () devuelve el número de milisegundos desde la medianoche del 1 de enero de, 1970 UTC</p>";
	document.getElementById("contenedor2").style.display = "block";
}

//Propiedad parseFloat(string)
...
var n = a + b + c + d + e + f + g + "<br>" + h + i + j + k +l;
	document.getElementById("demo3").innerHTML = n;
document.getElementById("demo4").innerHTML = 
	"p> función parseInt() analiza una cadena y devuelve un entero.<br>El parámetro radix se utiliza para especificar qué sistema de numeración a ser utilizado, por ejemplo, un radix de 16 (hexadecimal) indica que el número en la cadena debe ser analizada de un número hexadecimal a un número decimal.<br>Si se omite el parámetro radix, JavaScript supone lo siguiente:<br>Si la cadena comienza con "0x", la raíz es 16 (hexadecimal)<br>Si la cadena comienza con "0", la raíz es 8 (octal). Esta característica está en desuso<br>Si la cadena comienza con cualquier otro valor, la raíz es 10 (decimal)<br>Nota: Sólo se devuelve el primer número de la cadena!<br>Nota: se permiten espacios iniciales y finales.<br>Nota: Si el primer carácter no puede ser convertido a un número, parseInt () devuelve NaN.<br>Nota: . Mayor navegadores resultarán parseInt ( "010") como 8, porque las versiones anteriores de ECMAScript, (mayores de ECMAScript 5, utiliza la base octal (8) por defecto cuando la cadena comienza con "0" A partir de ECMAScript 5, el valor predeterminado es el radix decimal (10).</p>";
	document.getElementById("contenedor2").style.display = "block";
}