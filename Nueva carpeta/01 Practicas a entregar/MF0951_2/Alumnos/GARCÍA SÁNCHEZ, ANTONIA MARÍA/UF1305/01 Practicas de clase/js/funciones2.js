...
function esFinito() {
	var res ="";
	res = "¿El número 123 es finito? " + "<strong>" + Number.isFinite(123) + "</strong><br>";
	...
	res = res + "¿El número 1.23 es finito? " + "<strong>" + Number.isFinite(1.23) + "</strong><br>";	res = res + "¿El número \"123\" es finito? " + "<strong>" + Number.isFinite('123') + "</strong><br>";
	...
	document.getElementById("demo1").innerHTML = "<p>El método Number.isFinite() determina si un valor es un número finito. Este método devuelve verdadero si el valor del número es equivale a un número finito, de lo contrario, devuelve falso.</p>" + "<p>El método Number.isFinite() es diferente a la función global isFinite(). La función global isFinite() convierte el valor probado en un número, y a continuación, lo pone a prueba. El método Number.isFinite() no convierte los valores a un número, y no devolverá verdadero si el valor no es de tipo Number. Ambas funciones al ejecutarse devuelven un valor booleano, true (verdadero) o false (falso).</p>";
}

//Método isInteger()
function esEntero() {
	var res ="";
	res = "¿Es entero 123? " + "<strong>" + Number.isInteger(123) + "</strong><br>";
	...
	res = res + "¿Es entero 1.23? " + "<strong>" + Number.isInteger(1.23) + "</strong><br>";	res = res + "¿Es entero \"123\"? " + "<strong>" + Number.isInteger('123') + "</strong><br>";
	...
	res = res + "¿Es entero \"10\" + 20:? " + "<strong>" + Number.isInteger('2005/12/12') + "</strong><br>";	
...
function noEsNumero() {
	var res ="";
	res = "¿No es un número 123? " + "<strong>" + Number.isNaN(123) + "</strong><br>";
	...
	res = res + "¿No es un número 1.23? " + "<strong>" + Number.isNaN(1.23) + "</strong><br>";	res = res + "¿No es un número \"123\"? " + "<strong>" + Number.isNaN('123') + "</strong><br>";
	...
	res = res + "¿No es un número \"10\" + 20:? " + "<strong>" + Number.isNaN('2005/12/12') + "</strong><br>";	
