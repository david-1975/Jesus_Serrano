...
"<p>Nota: Sólo se devuelve el primer número de la cadena!<br>" + 
"Nota: se permiten espacios iniciales y finales.<br>" +
"Nota: Si el primer carácter no puede ser convertido a un número, parseFloat () devuelve NaN.</p>";
...
var n = a + b + c + d + e + f + g + "<br>" + h + i + j + k +l;
  ...
  document.getElementById("demo3").innerHTML = 
  "<p>La función parseInt () analiza una cadena y devuelve un entero.</p><p>El parámetro radix se utiliza para especificar qué sistema de numeración a ser utilizado, por ejemplo, un radix de 16 (hexadecimal) indica que el número en la cadena debe ser analizada de un número hexadecimal a un número decimal.</p>" + 
  "<p>Si se omite el parámetro radix, JavaScript supone lo siguiente:" +
  "Si la cadena comienza con \"0x\", la raíz es 16 (hexadecimal)<br>" + 
"Si la cadena comienza con \"0\", la raíz es 8 (octal).<br>" +
"Si la cadena comienza con cualquier otro valor, la raíz es 10 (decimal)</p>" +
